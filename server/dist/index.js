...
// src/modules/routes/auth-routes.ts
var import_express = __toESM(require("express"));

// src/modules/controller/auth-controller.ts
...
var userSchema_default = userModel;

// src/modules/repositories/auth-repository.ts
var AuthRepository = class {
  //Login
  userLogin(email) {
    return __async(this, null, function* () {
      try {
        const user = yield userSchema_default.find({ email });
        return user;
      } catch (error) {
  ...
  userRegistration(userData) {
    return __async(this, null, function* () {
      try {
        const user = yield userSchema_default.create(userData);
        return user;
      } catch (error) {
  ...
  isUserexists(email) {
    return __async(this, null, function* () {
      try {
        const userdata = yield userSchema_default.find({ email });
        return userdata;
      } catch (error) {
...
// src/modules/services/auth-service.ts
...
var AuthController = class {
  ...
  login(req, res) {
    return __async(this, null, function* () {
      ...
      try {
        const userData = yield authService.loginUser(email);
        if (userData.length > 0) {
          const userVerify = yield import_bcrypt.default.compare(password, userData[0].password);
          if (userVerify) {
            const token = import_jsonwebtoken.default.sign({ userId: userData[0]._id }, jwtSecret, { expiresIn: "1h" });
  ...
  registerUser(req, res) {
    return __async(this, null, function* () {
      try {
        ...
        const userDetails = yield authService.isUserExists(email);
        if (userDetails && (userDetails == null ? void 0 : userDetails.length) > 0) {
          return res.status(401).json({ message: "user already exists" });
        } else {
          let encrptpassword = yield import_bcrypt.default.hash(password, 10);
          userData.password = encrptpassword;
          const user = yield authService.registerUser(userData);
          if (user) {
...
// src/modules/routes/file-routes.ts
var import_express2 = __toESM(require("express"));

// src/modules/controller/user-controller.ts
var import_jsonwebtoken2 = __toESM(require_jsonwebtoken());

// src/model/userFileSchema.ts
var import_mongoose3 = __toESM(require("mongoose"));
var fileSchema = new import_mongoose3.Schema({
  userId: { type: import_mongoose3.Schema.Types.ObjectId, ref: "user" },
  filename: String,
  uniqueCode: String
});
var fileModel = import_mongoose3.default.model("File", fileSchema);
var userFileSchema_default = fileModel;
...
var UserRepository = class {
  ...
  userFileUpload(data) {
    return __async(this, null, function* () {
      try {
        const createdData = yield userFileSchema_default.create(data);
        return createdData;
      } catch (error) {
  ...
  userFileDelete(data) {
    return __async(this, null, function* () {
      try {
        const deleteFile = yield userFileSchema_default.findOneAndDelete({ uniqueCode: data });
        return deleteFile;
      } catch (error) {
  ...
  //file download
  userFileDownload(data) {
    return __async(this, null, function* () {
      try {
        const fileToDownload = yield userFileSchema_default.findOne({ uniqueCode: data });
  ...
  getAllFiles(data) {
    return __async(this, null, function* () {
      try {
        const getAllFiles = yield userFileSchema_default.find({ userId: data });
        return getAllFiles;
      } catch (error) {
...
var jwtSecret2 = process.env.JWT_KEY;
var UserController = class {
  ...
  fileDelete(req, res) {
    return __async(this, null, function* () {
      ...
      try {
        const deleteResult = yield userService.deleteFile(fileId);
        if (deleteResult) {
          const { filename } = deleteResult;
          const PATH = import_path.default.join(__dirname, "..", "..", "..", "uploads", filename);
          import_fs.default.unlink(PATH, (err) => {
            console.error(err);
          });
  ...
  fileDownload(req, res) {
    return __async(this, null, function* () {
      ...
      try {
        const fileDownload = yield userService.downloadFile(uniqueCode);
        if (fileDownload) {
          const { filename } = fileDownload;
          const filePath = import_path.default.join(__dirname, "..", "..", "..", "uploads", filename);
  ...
  getAllFiles(req, res) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const userId = decodedToken.userId;
        const allFiles = yield userService.getAllFiles(userId);
        if ((allFiles == null ? void 0 : allFiles.length) > 0) {
...
var upload = (0, import_multer2.default)({ storage });
...
var file_routes_default = userRouter;
